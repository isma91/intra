...
/*
 * long condition to check if the config file is truly fullied, can grow with time
 */
if (file_exists("../config.php") || !empty($configFile) || is_array($configFile) || !empty($configFile["install"])) {
	header('Location: ./../');
}
?>
<!DOCTYPE html>
